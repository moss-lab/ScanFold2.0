...
def main(args):
    ...
    if structure_extract == True:
        ...
        logging.info("Structure Extract failed for "+name+", must extract manually.")
        #continue
    # except:
...
if __name__ == "__main__":
    ...
    parser.add_argument('filename',  type=str,
                        help='input filename')
    parser.add_argument('--structure_extract', action='store_true', default=False,
                        help='Structure extract option')
